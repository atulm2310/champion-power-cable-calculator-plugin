...
<script type="text/javascript" src="<?= trailingslashit(get_stylesheet_directory_uri()) ?>/assets/js/assets/jspdf.min.js"></script>
...
<!-- <script src="<?= trailingslashit(get_stylesheet_directory_uri()) ?>/assets/js/select2.min.js"></script> -->
<!-- <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/assets/js/select2.min.js"></script> -->
